...
let userID = '406c2552-1dc3-4a6a-918c-fd1924e6adbe';
...
let proxyIP = 'cdn-b100.xn--b6gac.eu.org';//proxyIPs[Math.floor(Math.random() * proxyIPs.length)];
...
function getVLESSConfig(userID, hostName) {
  const wvlessws = `vless://${userID}@www.csgo.com:8880?encryption=none&security=none&type=ws&host=${hostName}&path=%2F%3Fed%3D2048#${hostName}`;
  const pvlesswstls = `vless://${userID}@www.csgo.com:8443?encryption=none&security=tls&type=ws&host=${hostName}&sni=${hostName}&fp=random&path=%2F%3Fed%3D2048#${hostName}`;
